          ...
          <div className="container ">
            <div className="row">
              ...
              <div className="col-lg-8">
                ...
                <div className={`mt-2 ${styles.description}`}>
                  ...
                  <p className={`ms-3 py-3 ${styles.skills_Height}`}>
                    {projectdetails.skills.map((item, indx) => {
                      return (
                        <div key={indx} className={`btn  ms-2 me-2 mt-2 ${styles.project_skills}`}>
                ...
                {/* three D */}
                {projectdetails.lines.length !== 0 && (
                  <div className={` ${styles.description}`}>
                    <p className="ms-3 pt-3">3D Design </p>
                    <span></span>
                    <NewThree showBtn={false} projectLines={projectdetails.lines} />
                  </div>
                )}
                    ...
                    <div className=" ">
                      ...
                      <div className="d-flex align-content-center">
                        <img
                          ...
                          src={"http://localhost:3000/" + projectdetails.createdBy.image}
                          alt={projectdetails.userName}
                        />
                        <div className="">
                          <h6>{projectdetails.createdBy.userName}</h6>
                          <p>
                            <i className="fa-solid fa-briefcase me-2"></i> 3d designer
                          </p>
                        </div>
                      </div>
                    </div>
