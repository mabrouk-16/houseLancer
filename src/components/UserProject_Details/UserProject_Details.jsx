...
import styles from './UserProject_Details.module.css'
...
import UserProjectsOffers from '../UserProjectsOffers/UserProjectsOffers';
function UserProject_Details() {
    let total = 0;
                        ...
                        <div className="row">
                            ...
                            <div className="col lg-8">
                                ...
                                <div className={`mt-2 ${styles.description}`}>
                                    ...
                                    <span></span>
                                    <div className={`ms-3 py-3 mb-3 ${styles.skills_Height}`}>{projectdetails.skills.map((item, indx) => {
                                ...
                                <div className="col-lg-8">
                                    ...
                                    <div className={`my-3 ${styles.All_Offers}`}>
                                        ...
                                        <div>
                                            ...
                                            <UserProjectsOffers projectId={projectdetails._id} />
                                        </div>
