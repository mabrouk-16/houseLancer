      ...
      >
        <div className={`${styles.card_bg} p-3 rounded-2 mt-5 mb-5`}>
          <MDBCardBody className="px-1">
            <h2 className="text-uppercase fs-5 text-center mb-3">Create an account</h2>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <MDBInput
                {...register("firstName", {
                  ...
                  pattern: {
                    value: /^[A-Za-z]{3,15}$/,
                    message: "first name must be character only and between 3,15",
                  },
                })}
                className={`mb-3 ${errors.firstName && "is-invalid"} ${
                  !errors.firstName && isDirty ? "is-valid" : ""
                }`}
                wrapperClass="mb-4"
                label="First Name"
                size="lg"
              ...
              <MDBInput
                {...register("lastName", {
                  ...
                  pattern: {
                    value: /^[A-Za-z]{3,15}$/,
                    message: "last name must be character only and between 3,15",
                  },
                })}
                className={`mb-3 ${errors.lastName && "is-invalid"} ${
                  !errors.lastName && isDirty ? "is-valid" : ""
                }`}
                wrapperClass="mb-4"
                label="First Name"
                size="lg"
              ...
              <MDBInput
                ...
                className={`mb-3 ${errors.password && "is-invalid"} ${
                  !errors.password && isDirty ? "is-valid" : ""
                }`}
                wrapperClass="mb-3"
                label="Password"
                size="lg"
              ...
              <MDBInput
                ...
                className={`mb-3 ${errors.cPassword && "is-invalid"} ${
                  !errors.cPassword && isDirty ? "is-valid" : ""
                }`}
                wrapperClass="mb-3"
