    ...
    <>
      ...
      >
        <div className="container-fluid">
          ...
          <button
            className={`navbar-toggler ${styles.noBoxShadow}`}
            type="button"
                ...
                <div className={`dropdown  `}>
                  ...
                  >
                    <li className="d-flex align-items-center justify-content-center mt-2">
                      ...
                      />
                      <NavLink
                        className={`${styles.linksss} fs-6 bg-transparent `}
                        role=""
                        to="profile"
                      >
                        {user?.userName}
                    ...
                    <li>
                      <NavLink className={`${styles.linkss} btn mt-3`} to="setting">
                        Settings
                      </NavLink>
                    </li>
                    <li>
                      <span
                        className={`${styles.linkss} btn mt-2 mb-3`}
                        role="button"
                        onClick={logOut}
                      >
                        Logout
